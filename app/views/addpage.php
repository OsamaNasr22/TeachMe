<form action="" method="post" class="form-horizontal" enctype="multipart/form-data">
    ...
    <div class="col-sm-10">
        <input type="text" class="form-control" id="P_Name" name="p_name" placeholder="Enter Page Name">
    </div>
  </div>
     <div class="form-group">
    ...
    <div class="col-sm-10">
        <textarea  class="form-control" id="p_content" name="p_content" placeholder="Page Content"></textarea>
    </div>
  </div>
     <div class="form-group"> 
